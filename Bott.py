...
user_state = {}  # для збереження станів користувача
...
def telegram_webhook():
    ...
    if text.startswith("Змінити QTY"):
        ...
        send_telegram("⚠️ Використовуй кнопку для зміни QTY", keyboard=True)
...
# ... [тут залишаємо весь твій існуючий код без змін: get_position_info, get_total_balance, status_report, close_current_position, open_position, get_current_position_side, check_mail] ...
